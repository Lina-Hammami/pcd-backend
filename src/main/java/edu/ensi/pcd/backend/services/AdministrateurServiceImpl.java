...
import edu.ensi.pcd.backend.repos.AbsenceRepository;
import edu.ensi.pcd.backend.repos.AdministrateurRepository;
import edu.ensi.pcd.backend.repos.AlerteRepository;
import edu.ensi.pcd.backend.repos.ClasseRepository;
import edu.ensi.pcd.backend.repos.EmploiRepository;
import edu.ensi.pcd.backend.repos.EtudiantRepository;
import edu.ensi.pcd.backend.repos.HoraireRepository;
import edu.ensi.pcd.backend.repos.MatiereRepository;
import edu.ensi.pcd.backend.repos.ProfesseurRepository;
import edu.ensi.pcd.backend.repos.SalleRepository;
import edu.ensi.pcd.backend.repos.SeanceRepository;
